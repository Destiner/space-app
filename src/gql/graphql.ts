...
export type SpaceAttestationQueryVariables = Exact<{
  recipient?: InputMaybe<Scalars["String"]["input"]>;
  context?: InputMaybe<Scalars["String"]["input"]>;
}>;

export type SpaceAttestationQuery = {
  __typename?: "Query";
  personalAttestation: Array<{ __typename?: "Attestation"; id: string }>;
  attestations: Array<{ __typename?: "Attestation"; attester: string }>;
};

export const SpaceAttestationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SpaceAttestation" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            alias: { kind: "Name", value: "personalAttestation" },
            name: { kind: "Name", value: "attestations" },
            arguments: [
              {
                kind: "Argument",
          ...
          },
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "attester" } },
              ],
            },
          },
        ],
  ...
  SpaceAttestationQueryVariables
>;
